...
/**
 * Represents a data provider providing Base64 format converters with invalid standard Base64 value, expected throwable class name and expected throwable message.
 * @package codekandis/base64-codec
 * @author Christian Ramelow <info@codekandis.net>
 */
class Base64FormatConvertersWithInvalidStandardBase64ValueExpectedThrowableClassNameAndExpectedThrowableMessageDataProvider implements DataProviderInterface
{
	/**
	 * @inheritDoc
	 */
	...
	public static function provideData(): iterable
	{
		return [
			0 => [
				...
				'expectedThrowableMessage'   => InvalidStandardBase64ValueException::ERROR_INVALID_STANDARD_BASE64_VALUE
			]
		];
	}
}
