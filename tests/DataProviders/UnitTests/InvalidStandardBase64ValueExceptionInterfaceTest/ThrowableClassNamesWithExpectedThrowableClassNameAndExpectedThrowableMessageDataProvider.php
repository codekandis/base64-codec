...
namespace CodeKandis\Base64Codec\Tests\DataProviders\UnitTests\InvalidStandardBase64ValueExceptionInterfaceTest;
...
class ThrowableClassNamesWithExpectedThrowableClassNameAndExpectedThrowableMessageDataProvider implements DataProviderInterface
{
	...
	public static function provideData(): iterable
	{
		return [
			0 => [
				'throwableClassName'         => $throwableClassName = InvalidStandardBase64ValueException::class,
