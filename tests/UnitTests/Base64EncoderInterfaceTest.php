...
class Base64EncoderInterfaceTest extends TestCase
{
	...
	public function testIfMethodEncodeToStandardEncodesToStandardBase64ValueCorrectly( Base64EncoderInterface $base64Encoder, string $unencodedValue, string $expectedStandardBase64Value ): void
	{
		$resultedEncodedValue = $base64Encoder->encodeToStandard( $unencodedValue );

		static::assertSame( $expectedStandardBase64Value, $resultedEncodedValue );
	}
