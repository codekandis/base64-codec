...
abstract class Base64Formats
{
	 ...
	 * @var string
	 */
	public const STANDARD_FORMAT = '^[A-Za-z0-9/\+]+=*$';
	 ...
	 * @var string
	 */
	public const STANDARD_UNIQUE_CHARACTER_SUBSET = [
		'/',
		'+',
		'='
	];
	 ...
	 * @var string
	 */
	public const URI_SAFE_FORMAT = '^[A-Za-z0-9_\-]+$';
	 ...
	 * @var string
	 */
	public const URI_SAFE_UNIQUE_CHARACTER_SUBSET = [
		'_',
		'-',
		''
	];
